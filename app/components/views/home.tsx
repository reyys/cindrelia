  ...
  <>
    ...
    <section className="py-32 px-6 md:px-12 bg-[#050505] text-[#F5F5F0] overflow-hidden">
      <Transition className="flex flex-col md:flex-row justify-between items-end mb-20">
        ...
        <button
          onClick={() => setView("collections")}
          className="border-b border-white pb-1 uppercase text-xs tracking-widest hover:text-[#Cfb53b] hover:border-[#Cfb53b] transition-colors interactive"
        >
          ...
          <Transition key={i} className="group cursor-pointer interactive">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 translate-y-full group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                <button className="bg-[#F5F5F0] text-black px-6 py-2 uppercase text-xs tracking-widest hover:bg-[#Cfb53b]">
                  Quick Add
                </button>
              </div>
            </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-[#F5F5F0]">
          ...
          <Transition className="mt-8">
            <button
              ...
              className="border border-[#F5F5F0] text-[#F5F5F0] px-12 py-4 uppercase tracking-widest hover:bg-[#F5F5F0] hover:text-black transition-all duration-500 interactive"
            >
              Explore Campaign
            </button>
          </Transition>
    ...
    <SectionCategory setView={setView} />
    ...
    <section className="py-20 px-6 md:px-12 bg-[#F5F5F0] text-[#050505]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <button
            onClick={() => setView("atelier")}
            className="flex items-center gap-4 uppercase text-sm tracking-widest font-bold hover:gap-6 transition-all interactive group"
          >
            Read Our Story{" "}
